...
const fetchTours = async () => {
  ...
  return (
      ...
      <div className='max-w-6xl w-full px-4'>
        ...
        <div className='flex justify-center mt-6'>
          <button 
            ...
            className="bg-green-500 text-white py-3 px-6 rounded-lg hover:bg-green-600 transition-colors duration-200 font-semibold shadow-lg"
          >
    ...
    <button 
     ...
     className="bg-blue-500 text-white py-3 px-6 rounded-lg hover:bg-blue-600 transition-colors duration-200 font-semibold shadow-lg"
    >Refresh Tours
    </button> </div>)}
</div>
    </div>
